...
document.addEventListener('DOMContentLoaded', () => {
  const wordGroups = {
    ...
    longVowel: {
      a_e: ['spade','mate','game','afraid','bake','gave','way','grey','rake','great','holiday','Gayle','may','clay','wake','weight','baked','holidays','played','amazed','stayed','stay','against','they'],
      ea_ee: ['people','need','eagle','funny','meet','breeze','maybe','breathe','puppy','lazy','leaf','tree','meat','grumpy','peek','released','speaking','revealed','happy','valley','seat','thief','create','believe','seized','green','three','clean','hungry','gleam'],
      igh_ie: ['find','right','flight','skies','sight','five','try','height','finally','dive','kind','why','fly','myself','direct','light','by','flies','wild','directly','night','my','ride','realise','quite','live','white','mild','realise','delighted'],
      o_e_ow: ['go','Owen','drove','though','both','so','low','home','hoped','nose','ago','envelope','propose','floated','only','Joan','won’t','wrote','don’t','close','know','show','own','owned','spoke','road','cove','Rowan','hope','own'],
      oo: ['food','soon','bedroom','receive','special','mood','swoop','move','place','especially','room','cool','movie','face','office','suit','truth','soup','decided','distance','through','true','flew','exciting','receipt','cockatoo','kangaroo','grew','chew','blew']
    }
  };
